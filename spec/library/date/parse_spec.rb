...
describe "Date#parse" do
  ...
  it "parses a day name into a Date object" do
    NATFIXME 'Support string format', exception: Date::Error do
      d = Date.parse("friday")
  ...
  it "parses DDD as year day number" do
    NATFIXME 'Support DDD', exception: Date::Error do
      d = Date.parse("100")
  ...
  it "parses YYDDD as year and day number in 1969--2068" do
    NATFIXME 'Support YYDDD', exception: Date::Error do
      d = Date.parse("10100")
  ...
  it "parses YYYYDDD as year and day number" do
    NATFIXME 'Support YYYYDDD', exception: Date::Error do
