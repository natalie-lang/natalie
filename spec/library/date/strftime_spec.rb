...
describe "Date#strftime" do
  ...
  it "should be able to show the timezone with a : separator" do
    NATFIXME 'it should be able to show the timezone with a : separator', exception: SpecFailedException do
  ...
  it 'shows the number of milliseconds since epoch' do
    NATFIXME 'Implement DateTime', exception: NameError, message: 'uninitialized constant DateTime' do
      DateTime.new(1970, 1, 1).strftime('%Q').should == "0"
    end
    NATFIXME 'it shows the number of milliseconds since epoch', exception: SpecFailedException do
      @date.strftime("%Q").should == "955238400000"
    end
  end

  it "should be able to show a full notation" do
    NATFIXME 'it should be able to show a full notation', exception: SpecFailedException do
