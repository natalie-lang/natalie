...
describe "A nested method definition" do
  ...
  it "creates a class method when evaluated in a class method" do
    ...
    -> { Object.a_class_method }.should raise_error(NoMethodError)
    NATFIXME 'it creates a class method when evaluated in a class method', exception: SpecFailedException do
  ...
  it "creates a method in the surrounding context when evaluated in a def expr.method" do
    ...
    NATFIXME 'it creates a method in the surrounding context when evaluated in a def expr.method', exception: SpecFailedException do
  ...
  it "inside an instance_eval creates a singleton method" do
    ...
    NATFIXME 'inside an instance_eval it creates a singleton method', exception: SpecFailedException do
...
describe "A method definition in an eval" do
  ...
  it "creates a class method" do
    ...
    NATFIXME 'it creates a class method via eval', exception: SpecFailedException do
...
describe "a method definition that sets more than one default parameter all to the same value" do
  ...
  it "assigns them all the same object by default" do
    NATFIXME 'it assigns them all the same object by default', exception: SpecFailedException do
      foo.should == [{},{},{}]
      a, b, c = foo
      a.should eql(b)
      a.should eql(c)
  ...
  it "allows the first argument to be given, and sets the rest to null" do
    NATFIXME 'it allows the first argument to be given, and sets the rest to null', exception: SpecFailedException do
  ...
  it "only allows overriding the default value of the first such parameter in each set" do
    NATFIXME 'it only allows overriding the default value of the first such parameter in each set', exception: SpecFailedException do
  ...
  it "treats the argument after the multi-parameter normally" do
    NATFIXME 'it treats the argument after the multi-parameter normally', exception: SpecFailedException do
      bar.should == [1,1,1,2]
