...
describe "delegation with def(...)" do
  it "delegates rest and kwargs" do
    ...
    NATFIXME 'it delegates rest and kwargs', exception: SpecFailedException do
  ...
  it "delegates a block argument" do
    ...
    block = proc {}
    NATFIXME 'it delegates a block argument', exception: SpecFailedException do
  ...
  it "parses as open endless Range when brackets are omitted" do
    ...
    NATFIXME 'it parses as open endless Range when brackets are omitted', exception: SpecFailedException do
...
describe "delegation with def(*)" do
  it "delegates rest" do
    ...
    NATFIXME 'it delegates rest', exception: SpecFailedException do
...
describe "delegation with def(**)" do
  it "delegates kwargs" do
    ...
    NATFIXME 'it delegates kwargs', exception: SpecFailedException do
...
describe "delegation with def(&)" do
  it "delegates an anonymous block parameter" do
    ...
    block = proc {}
    NATFIXME 'it delegates an anonymous block parameter', exception: SpecFailedException do
