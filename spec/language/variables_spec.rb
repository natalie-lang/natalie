...
describe "Multiple assignment" do
  context "with a single RHS value" do
    ...
    it "assigns a MLHS with leading splat" do
      (*a, b, c = 1).should == 1
      NATFIXME 'it assigns a MLHS with leading splat', exception: SpecFailedException do
        [a, b, c].should == [[], 1, nil]
      end
    end
  ...
  context "with a MRHS value" do
    ...
    it "assigns a grouped LHS with splats from nested Arrays for nested arrays" do
      ...
      NATFIXME 'it assigns a grouped LHS with splats from nested Arrays for nested arrays', exception: SpecFailedException do
    ...
    it "calls #to_a to convert a splatted Object value in a MRHS" do
      ...
      NATFIXME 'it calls #to_a to convert a splatted Object value in a MRHS', exception: SpecFailedException do
    ...
    it "calls #to_ary to convert a splatted Object when the position receiving the value is a multiple assignment" do
      x = mock("multi-assign mixed splatted RHS")
      NATFIXME 'it calls #to_ary to convert a splatted Object when the position receiving the value is a multiple assignment', exception: SpecFailedException do
    ...
    it "raises a TypeError if #to_ary does not return an Array in a MRHS" do
      x = mock("multi-assign mixed splatted RHS")
      NATFIXME 'it raises a TypeError if #to_ary does not return an Array in a MRHS', exception: SpecFailedException do
        x.should_receive(:to_ary).and_return(x)
  ...
  describe "global variable" do
    context "when global variable is uninitialized" do
      it "warns about accessing uninitialized global variable in verbose mode" do
        ...
        NATFIXME 'it warns about accessing uninitialized global variable in verbose mode', exception: SpecFailedException do
