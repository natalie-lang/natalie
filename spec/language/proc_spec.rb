...
describe "A Proc" do
  ...
  describe "taking |a, *b| arguments" do
    ...
    it "does not destructure a single Array value yielded" do
      NATFIXME 'it does not destructure a single Array value yielded', exception: SpecFailedException do
    ...
    it "does not call #to_ary to convert a single passed object to an Array" do
      obj = mock("block yield to_ary")
      NATFIXME 'it does not call #to_ary to convert a single passed object to an Array', exception: SpecFailedException do
        obj.should_not_receive(:to_ary)
  ...
  describe "taking |a, | arguments" do
    ...
    it "does not destructure when passed a single Array" do
      NATFIXME 'it does not destructure when passed a single Array', exception: SpecFailedException do
        @l.call([1,2]).should == [1, 2]
      end
    end
