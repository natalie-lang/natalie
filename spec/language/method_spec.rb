...
describe "warning about not used block argument" do
  ruby_version_is "3.4" do
    it "warns when passing a block argument to a method that never uses it" do
      ...
      NATFIXME 'it warns when passing a block argument to a method that never uses it', exception: SpecFailedException, message: /should have printed a warning/ do
        -> {
    ...
    it "warns when passing a block argument to a method that calls #block_given?" do
      NATFIXME 'it warns when passing a block argument to a method that calls #block_given?', exception: SpecFailedException, message: /should have printed a warning/ do
    ...
    it "warns only once per call site" do
      ...
      NATFIXME 'it warns only once per call site', exception: SpecFailedException, message: /should have printed a warning/ do
        -> {
          m_that_does_not_use_block { }
    ...
    it "can be disabled with :strict_unused_block warning category" do
      ...
      NATFIXME 'it can be disabled with :strict_unused_block warning category', exception: SpecFailedException, message: 'Expected a warning but received none' do
