...
describe "A Symbol literal" do
  ...
  it 'inherits the encoding of the magic comment and can have a binary encoding' do
    NATFIXME 'it inherits the encoding of the magic comment and can have a binary encoding', exception: SpecFailedException do
  ...
  it "can contain null in the string" do
    NATFIXME 'should use ASCII encoding', exception: SpecFailedException do
