...
describe "Execution variable $:" do
  ...
  it "does not include the current directory" do
    NATFIXME 'Implement $:', exception: NoMethodError, message: "undefined method `include?' for nil:NilClass" do
      $:.should_not include(".")
    end
  end
  ...
  it "can be changed via <<" do
    NATFIXME 'Implement $:', exception: NoMethodError, message: "undefined method `delete' for nil:NilClass" do
      $: << "foo"
      $:.should include("foo")
    ensure
      $:.delete("foo")
...
describe "Global variable $0" do
  ...
  platform_is :linux, :darwin do
    it "actually sets the program name" do
      ...
      $0 = title
      NATFIXME 'actually sets the program name', exception: SpecFailedException do
  ...
  it "raises a TypeError when not given an object that can be coerced to a String" do
    NATFIXME 'raises a TypeError when not given an object that can be coerced to a String', exception: SpecFailedException do
...
describe "The predefined global constants" do
  ...
  it "includes TOPLEVEL_BINDING" do
    NATFIXME 'Add TOPLEVEL_BINDING', exception: SpecFailedException do
...
describe "$LOAD_PATH.resolve_feature_path" do
  it "returns what will be loaded without actual loading, .rb file" do
    NATFIXME 'Implement $LOAD_PATH', exception: NoMethodError, message: "undefined method `resolve_feature_path' for nil:NilClass" do
...
describe "Predefined global $=" do
  ...
  it "warns when accessed" do
    NATFIXME 'Should warn for $=', exception: SpecFailedException do
