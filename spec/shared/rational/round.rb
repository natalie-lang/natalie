...
describe :rational_round, shared: true do
  ...
  describe "with no arguments (precision = 0)" do
    # NATFIXME: wrong number of arguments (given 2, expected 0) (ArgumentError)
    ...
    # NATFIXME: wrong number of arguments (given 2, expected 0) (ArgumentError)
    xit "returns the truncated value toward the nearest integer" do
