...
describe :strftime_time, shared: true do
  ...
  describe "with %L" do
    it "formats the milliseconds of the second" do
      NATFIXME 'it formats the milliseconds of the second', exception: SpecFailedException do
  ...
  describe "with %N" do
    it "formats the nanoseconds of the second with %N" do
      NATFIXME 'it formats the nanoseconds of the second with %N', exception: SpecFailedException do
    ...
    it "formats the milliseconds of the second with %3N" do
      NATFIXME 'it formats the milliseconds of the second with %3N', exception: SpecFailedException do
        @new_time[2000, 4, 6, 0, 0, Rational(50, 1000)].strftime("%3N").should == "050"
      end
    end

    it "formats the microseconds of the second with %6N" do
      NATFIXME 'it formats the microseconds of the second with %6N', exception: SpecFailedException do
        @new_time[2000, 4, 6, 0, 0, Rational(42, 1000)].strftime("%6N").should == "042000"
      end
    end

    it "formats the nanoseconds of the second with %9N" do
      NATFIXME 'it formats the nanoseconds of the second with %9N', exception: SpecFailedException do
    ...
    it "formats the picoseconds of the second with %12N" do
      NATFIXME 'it formats the picoseconds of the second with %12N', exception: SpecFailedException do
  ...
  it "returns the timezone with %Z" do
    ...
    zone = time.zone
    NATFIXME 'it returns the timezone with %Z', exception: SpecFailedException do
  ...
  describe "with %z" do
    ...
    it "formats a time with fixed offset as '+/-HH:MM' with ':' specifier" do
      NATFIXME "it formats a time with fixed offset as '+/-HH:MM' with ':' specifier", exception: SpecFailedException do
    ...
    it "formats a time with fixed offset as '+/-HH:MM:SS' with '::' specifier" do
      NATFIXME "it formats a time with fixed offset as '+/-HH:MM:SS' with '::' specifier", exception: SpecFailedException do
  ...
  it "should be able to show default Logger format" do
    ...
    NATFIXME 'it should be able to show default Logger format', exception: SpecFailedException do
