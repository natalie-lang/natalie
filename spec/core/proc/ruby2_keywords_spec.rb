...
describe "Proc#ruby2_keywords" do
  ...
  it "applies to the underlying method and applies across duplication" do
    ...
    NATFIXME 'applies to the underlying method and applies across duplication', exception: SpecFailedException do
  ...
  it "prints warning when a proc does not accept argument splat" do
    ...
    NATFIXME 'prints warning when a proc does not accept argument splat', exception: SpecFailedException do
      -> {
        f.ruby2_keywords
  ...
  it "prints warning when a proc accepts keywords" do
    ...
    NATFIXME 'prints warning when a proc accepts keywords', exception: SpecFailedException do
      -> {
        f.ruby2_keywords
      }.should complain(/Skipping set of ruby2_keywords flag for/)
    end
  ...
  it "prints warning when a proc accepts keyword splat" do
    ...
    NATFIXME 'prints warning when a proc accepts keyword splat', exception: SpecFailedException do
      -> {
        f.ruby2_keywords
      }.should complain(/Skipping set of ruby2_keywords flag for/)
    end
