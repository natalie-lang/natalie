...
describe "Kernel#rand" do
  ...
  it "returns an integer for a float argument greater than 1" do
    NATFIXME 'it returns an integer for a float argument greater than 1', exception: SpecFailedException do
      rand(1.3).should be_kind_of(Integer)
    end
  end

  it "returns a float for an argument between -1 and 1" do
    NATFIXME 'it returns a float for an argument between -1 and 1', exception: ArgumentError, message: /invalid argument - / do
  ...
  it "returns nil when range is backwards" do
    NATFIXME 'it returns nil when range is backwards', exception: ArgumentError, message: 'invalid argument - 1..0' do
  ...
  it "supports custom object types" do
    NATFIXME 'it supports custom object types', exception: ArgumentError, message: 'bad value for range' do
