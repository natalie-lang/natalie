...
describe "Kernel#raise" do
  ...
  it "raises ArgumentError when exception is part of the cause chain" do
    NATFIXME 'it raises ArgumentError when exception is part of the cause chain', exception: SpecFailedException do
      -> {
        begin
          raise "Error 1"
        rescue => e1
  ...
  it "re-raises a previously rescued exception with overwriting the cause when it's explicitly specified with :cause option" do
    ...
    begin
      ...
      NATFIXME "it re-raises a previously rescued exception with overwriting the cause when it's explicitly specified with :cause option", exception: SpecFailedException do
        e.cause.should == e4
      end
    end
  end
  ...
  it "re-raises a previously rescued exception that doesn't have a cause and is a cause of other exception without setting a cause implicitly" do
    begin
      ...
      e.should == e1
      NATFIXME "it re-raises a previously rescued exception that doesn't have a cause and is a cause of other exception without setting a cause implicitly", exception: SpecFailedException do
        e.cause.should == nil
      end
    end
  end
  ...
  it "re-raises a previously rescued exception that doesn't have a cause and is a cause of other exception (that wasn't raised explicitly) without setting a cause implicitly" do
    begin
      ...
      e.should == e1
      NATFIXME "it re-raises a previously rescued exception that doesn't have a cause and is a cause of other exception (that wasn't raised explicitly) without setting a cause implicitly", exception: SpecFailedException do
        e.cause.should == nil
      end
    end
  end
