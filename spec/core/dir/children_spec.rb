...
describe "Dir.children" do
  ...
  it "returns children transcoded to the default internal encoding" do
    NATFIXME "Pending encoding", exception: NameError, message: /uninitialized constant Encoding::EUC_KR/ do
...
describe "Dir#children" do
  ...
  it "returns the same result when called repeatedly" do
    NATFIXME 'it returns the same result when called repeatedly', exception: SpecFailedException do
