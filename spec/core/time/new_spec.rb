...
describe "Time.new with a utc_offset argument" do
  it "returns a non-UTC time" do
    NATFIXME 'it returns a non-UTC time', exception: SpecFailedException do
  ...
  it "returns a Time with a UTC offset of the specified number of Rational seconds" do
    NATFIXME 'it returns a Time with a UTC offset of the specified number of Rational seconds', exception: SpecFailedException do
  ...
  describe "with an argument that responds to #to_r" do
    it "coerces using #to_r" do
      ...
      NATFIXME 'it coerces using #to_r', exception: NoMethodError, message: "undefined method 'to_i' for an instance of MockNumeric" do
  ...
  it "returns a Time with a UTC offset specified as +HH" do
    NATFIXME 'Improve timezone parsing', exception: ArgumentError, message: '"+HH:MM", "-HH:MM", "UTC" or "A".."I","K".."Z" expected for utc_offset' do
  ...
  it "returns a Time with a UTC offset specified as +HHMMSS" do
    NATFIXME 'Support timezone name arguments', exception: ArgumentError, message: '"+HH:MM", "-HH:MM", "UTC" or "A".."I","K".."Z" expected for utc_offset' do
...
describe "Time.new with a timezone argument" do
  ...
  describe ":in keyword argument" do
    ...
    it "allows omitting minor arguments" do
      ...
      NATFIXME 'Implement Time#getlocal', exception: NoMethodError, message: "undefined method 'getlocal' for an instance of Time" do
    ...
    it "converts to a provided timezone if all the positional arguments are omitted" do
      NATFIXME 'it converts to a provided timezone if all the positional arguments are omitted', exception: SpecFailedException do
  ...
  describe "Time.new with a String argument" do
    it "parses an ISO-8601 like format" do
      ...
      NATFIXME 'it parses an ISO-8601 like format', exception: SpecFailedException do
    ...
    it "accepts precision keyword argument and truncates specified digits of sub-second part" do
      NATFIXME 'it accepts precision keyword argument and truncates specified digits of sub-second part', exception: SpecFailedException do
    ...
    it "returns Time in timezone specified in the String argument" do
      NATFIXME 'it returns Time in timezone specified in the String argument', exception: SpecFailedException do
    ...
    it "returns Time in timezone specified in the String argument even if the in keyword argument provided" do
      NATFIXME 'it returns Time in timezone specified in the String argument even if the in keyword argument provided', exception: SpecFailedException do
    ...
    it "returns Time in timezone specified with in keyword argument if timezone isn't provided in the String argument" do
      NATFIXME "it returns Time in timezone specified with in keyword argument if timezone isn't provided in the String argument", exception: SpecFailedException do
    ...
    it "converts precision keyword argument into Integer if is not nil" do
      ...
      NATFIXME 'Support precision argument', exception: ArgumentError, message: 'unknown keyword: :precision' do
    ...
    it "returns Time with correct subseconds when given seconds fraction is shorted than 6 digits" do
      NATFIXME 'it returns Time with correct subseconds when given seconds fraction is shorted than 6 digits', exception: SpecFailedException do
    ...
    it "returns Time with correct subseconds when given seconds fraction is milliseconds" do
      NATFIXME 'it returns Time with correct subseconds when given seconds fraction is milliseconds', exception: SpecFailedException do
    ...
    it "returns Time with correct subseconds when given seconds fraction is longer that 6 digits but shorted than 9 digits" do
      NATFIXME 'it returns Time with correct subseconds when given seconds fraction is longer that 6 digits but shorted than 9 digits', exception: SpecFailedException do
    ...
    it "returns Time with correct subseconds when given seconds fraction is nanoseconds" do
      NATFIXME 'it returns Time with correct subseconds when given seconds fraction is nanoseconds', exception: SpecFailedException do
    ...
    it "returns Time with correct subseconds when given seconds fraction is longer than 9 digits" do
      NATFIXME 'it returns Time with correct subseconds when given seconds fraction is longer than 9 digits', exception: SpecFailedException do
    ...
    it "raises ArgumentError if part of time string is missing" do
      NATFIXME 'it raises ArgumentError if part of time string is missing', exception: SpecFailedException do
        -> {
    ...
    ruby_version_is "3.2.3" do
      it "raises ArgumentError if the time part is missing" do
        NATFIXME 'it raises ArgumentError if the time part is missing', exception: SpecFailedException do
          -> {
            Time.new("2020-12-25")
      ...
      it "raises ArgumentError if day is missing" do
        NATFIXME 'it raises ArgumentError if day is missing', exception: SpecFailedException do
          -> {
            Time.new("2020-12")
          }.should raise_error(ArgumentError, /no time information|can't parse:/)
        end
    ...
    it "raises ArgumentError if subsecond is missing after dot" do
      NATFIXME 'it raises ArgumentError if subsecond is missing after dot', exception: SpecFailedException do
        -> {
    ...
    it "raises ArgumentError if String argument is not in the supported format" do
      NATFIXME 'it raises ArgumentError if String argument is not in the supported format', exception: SpecFailedException do
        -> {
    ...
    it "raises ArgumentError if date/time parts values are not valid" do
      NATFIXME 'it raises ArgumentError if date/time parts values are not valid', exception: SpecFailedException do
        -> {
    ...
    it "raises ArgumentError if utc offset parts are not valid" do
      NATFIXME 'it raises ArgumentError if utc offset parts are not valid', exception: SpecFailedException do
    ...
    it "raises ArgumentError if string has not ascii-compatible encoding" do
      NATFIXME 'it raises ArgumentError if string has not ascii-compatible encoding', exception: SpecFailedException do
        -> {
    ...
    it "raises ArgumentError if string doesn't start with year" do
      NATFIXME "it raises ArgumentError if string doesn't start with year", exception: SpecFailedException do
        -> {
          Time.new("a\nb")
    ...
    it "raises ArgumentError if string has extra characters after offset" do
      NATFIXME 'it raises ArgumentError if string has extra characters after offset', exception: SpecFailedException do
        -> {
    ...
    ruby_version_is "3.2.3" do
      it "raises ArgumentError when there are leading space characters" do
        NATFIXME 'it raises ArgumentError when there are leading space characters', exception: SpecFailedException do
      ...
      it "raises ArgumentError when there are trailing whitespaces" do
        NATFIXME 'it raises ArgumentError when there are trailing whitespaces', exception: SpecFailedException do
          -> { Time.new("2020-12-02 00:00:00 ") }.should raise_error(ArgumentError, /can't parse/)
          -> { Time.new("2020-12-02 00:00:00\t") }.should raise_error(ArgumentError, /can't parse/)
