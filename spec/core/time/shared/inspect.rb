...
describe :inspect, shared: true do
  ...
  xit "formats the local time following the pattern 'yyyy-MM-dd HH:mm:ss Z'" do
  ...
  xit "formats the fixed offset time following the pattern 'yyyy-MM-dd HH:mm:ss +/-HHMM'" do
