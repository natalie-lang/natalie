...
describe "Time.now" do
  ...
  describe ":in keyword argument" do
    ...
    it "raises ArgumentError if String argument and hours greater than 23" do
      NATFIXME 'it raises ArgumentError if String argument and hours greater than 23', exception: SpecFailedException do
    ...
    it "raises ArgumentError if String argument and minutes greater than 59" do
      NATFIXME 'it raises ArgumentError if String argument and minutes greater than 59', exception: SpecFailedException do
    ...
    ruby_bug '#20797', ''...'3.4' do
      it "raises ArgumentError if String argument and seconds greater than 59" do
        NATFIXME 'it raises ArgumentError if String argument and seconds greater than 59', exception: SpecFailedException do
