...
describe "Struct#deconstruct_keys" do
  ...
  it "requires one argument" do
    ...
    NATFIXME 'This is a repsonsibility of define_method, not of Struct', exception: SpecFailedException do
      -> {
  ...
  it "tries to convert a key with #to_int if index is not a String nor a Symbol, but responds to #to_int" do
    ...
    NATFIXME 'it tries to convert a key with #to_int if index is not a String nor a Symbol, but responds to #to_int', exception: NoMethodError, message: "undefined method 'to_sym' for an instance of MockObject" do
      key = mock("to_int")
