...
describe "BasicObject#equal?" do
  ...
  it "is unaffected by overriding object_id" do
    NATFIXME 'Unable to mock #object_id', exception: SpecFailedException, message: 'Cannot register stub for :object_id. This method is used internally and thus cannot be stubbed.' do
      o1 = mock("object")
