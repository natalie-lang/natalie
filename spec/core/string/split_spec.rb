...
describe "String#split with String" do
  # NATFIXME: Encoding
  xit "throws an ArgumentError if the string  is not a valid" do
  ...
  # NATFIXME: Encoding
  xit "throws an ArgumentError if the pattern is not a valid string" do
    str = 'проверка'
  ...
  # NATFIXME: suppresses trailing empty fields when limit isn't given or 0
  xit "suppresses trailing empty fields when limit isn't given or 0" do
  ...
  # NATFIXME: does not suppress trailing empty fields when a positive limit is given
  xit "does not suppress trailing empty fields when a positive limit is given" do
  ...
  # NATFIXME: raises a RangeError when the limit is larger than int
  xit "raises a RangeError when the limit is larger than int" do
    -> { "a,b".split(" ", 2147483649) }.should raise_error(RangeError)
  end

  # NATFIXME: defaults to $; when string isn't given or nil
  xit "defaults to $; when string isn't given or nil" do
    suppress_warning do
      old_fs = $;
      begin
        [",", ":", "", "XY", nil].each do |fs|
  ...
  # NATFIXME: ignores leading and continuous whitespace when string is a single space
  xit "ignores leading and continuous whitespace when string is a single space" do
  ...
  # NATFIXME: when limit is zero
  xdescribe "when limit is zero" do
  ...
  # NATFIXME: splits between characters when its argument is an empty string
  xit "splits between characters when its argument is an empty string" do
    "hi!".split("").should == ["h", "i", "!"]
  ...
  # NATFIXME: tries converting its pattern argument to a string via to_str
  xit "tries converting its pattern argument to a string via to_str" do
    obj = mock('::')
  ...
  # NATFIXME: tries converting limit to an integer via to_int
  xit "tries converting limit to an integer via to_int" do
    obj = mock('2')
  ...
  # NATFIXME: returns an empty array when whitespace is split on whitespace
  xit "returns an empty array when whitespace is split on whitespace" do
    " ".split(" ").should == []
    " \n ".split(" ").should == []
    "  ".split(" ").should == []
    " \t ".split(" ").should == []
...
describe "String#split with Regexp" do
  ...
  # NATFIXME: divides self on regexp matches
  xit "divides self on regexp matches" do
    " now's  the time".split(/ /).should == ["", "now's", "", "the", "time"]
    " x\ny ".split(/ /).should == ["", "x\ny"]
  ...
  # NATFIXME: defaults to $; when regexp isn't given or nil
  ...
  # NATFIXME: includes all captures in the result array
  xit "includes all captures in the result array" do
  ...
  # NATFIXME: applies the limit to the number of split substrings, without counting captures
  xit "applies the limit to the number of split substrings, without counting captures" do
    "aBaBa".split(/(B)()()/, 2).should == ["a", "B", "", "", "aBa"]
  end

  # NATFIXME: does not include non-matching captures in the result array
  xit "does not include non-matching captures in the result array" do
  ...
  # NATFIXME: Encoding
  xit "returns an ArgumentError if an invalid UTF-8 string is supplied" do
  ...
  # NATFIXME: allows concurrent Regexp calls in a shared context
  xit "allows concurrent Regexp calls in a shared context" do
    str = 'a,b,c,d,e'
  ...
  # NATFIXME: when a block is given
  xcontext "when a block is given" do
  ...
  xdescribe "for a String subclass" do
    ruby_version_is ''...'3.0' do
