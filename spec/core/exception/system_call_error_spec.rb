...
describe "SystemCallError.new" do
  ...
  it "accepts an optional custom message preceding the errno" do
    ...
    NATFIXME 'it accepts an optional custom message preceding the errno', exception: SpecFailedException, message: /should be an instance of Errno::EINVAL/ do
  ...
  it "accepts an optional third argument specifying the location" do
    ...
    NATFIXME 'it accepts an optional third argument specifying the location', exception: SpecFailedException, message: /should be an instance of Errno::EINVAL/ do
      exc.should be_an_instance_of(@example_errno_class)
    end
    exc.errno.should == @example_errno
  ...
  it "treats nil errno as unknown error value" do
    NATFIXME 'it treats nil errno as unknown error value', exception: TypeError, message: 'no implicit conversion of NilClass into Integer' do
  ...
  it "raises TypeError if message is not a String" do
    NATFIXME 'it raises TypeError if message is not a String', exception: SpecFailedException, message: /but instead raised nothing/ do
