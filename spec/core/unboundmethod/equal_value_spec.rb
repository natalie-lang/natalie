...
describe "UnboundMethod#==" do
  ...
  it "returns true if either is an alias for the other" do
    NATFIXME 'it returns true if either is an alias for the other', exception: SpecFailedException do
  ...
  it "returns true if both are aliases for a third method" do
    NATFIXME 'it returns true if both are aliases for a third method', exception: SpecFailedException do
      (@from_module == @alias_1).should == true
      (@alias_1 == @from_module).should == true
  ...
  it "returns true if same method but one extracted from a subclass" do
    NATFIXME 'it returns true if same method but one extracted from a subclass', exception: SpecFailedException do
  ...
  it "returns true if same method but extracted from two different subclasses" do
    NATFIXME 'it returns true if same method but extracted from two different subclasses', exception: SpecFailedException do
  ...
  it "returns true if methods are the same but added from an included Module" do
    NATFIXME 'it returns true if methods are the same but added from an included Module', exception: SpecFailedException do
  ...
  it "considers methods through aliasing equal" do
    ...
    NATFIXME 'it considers methods through aliasing equal', exception: SpecFailedException do
  ...
  it "considers methods through aliasing and visibility change equal" do
    ...
    NATFIXME 'it considers methods through aliasing and visibility change equal', exception: SpecFailedException do
      c.method(:new).should == c.method(:n)
      c.method(:n).should == Class.instance_method(:new).bind(c)
      c.method(:new).should == Class.instance_method(:new).bind(c)
    end
