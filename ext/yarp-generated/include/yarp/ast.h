...
enum yp_node_type {
    ...
    YP_IN_NODE = 67,
    YP_INSTANCE_VARIABLE_AND_WRITE_NODE = 68,
    YP_INSTANCE_VARIABLE_OPERATOR_WRITE_NODE = 69,
    YP_INSTANCE_VARIABLE_OR_WRITE_NODE = 70,
    YP_INSTANCE_VARIABLE_READ_NODE = 71,
    YP_INSTANCE_VARIABLE_TARGET_NODE = 72,
    YP_INSTANCE_VARIABLE_WRITE_NODE = 73,
    YP_INTEGER_NODE = 74,
    YP_INTERPOLATED_MATCH_LAST_LINE_NODE = 75,
    YP_INTERPOLATED_REGULAR_EXPRESSION_NODE = 76,
    YP_INTERPOLATED_STRING_NODE = 77,
    YP_INTERPOLATED_SYMBOL_NODE = 78,
    YP_INTERPOLATED_X_STRING_NODE = 79,
    YP_KEYWORD_HASH_NODE = 80,
    YP_KEYWORD_PARAMETER_NODE = 81,
    YP_KEYWORD_REST_PARAMETER_NODE = 82,
    YP_LAMBDA_NODE = 83,
    YP_LOCAL_VARIABLE_AND_WRITE_NODE = 84,
    YP_LOCAL_VARIABLE_OPERATOR_WRITE_NODE = 85,
    YP_LOCAL_VARIABLE_OR_WRITE_NODE = 86,
    YP_LOCAL_VARIABLE_READ_NODE = 87,
    YP_LOCAL_VARIABLE_TARGET_NODE = 88,
    YP_LOCAL_VARIABLE_WRITE_NODE = 89,
    YP_MATCH_LAST_LINE_NODE = 90,
    YP_MATCH_PREDICATE_NODE = 91,
    YP_MATCH_REQUIRED_NODE = 92,
    YP_MATCH_WRITE_NODE = 93,
    YP_MISSING_NODE = 94,
    YP_MODULE_NODE = 95,
    YP_MULTI_TARGET_NODE = 96,
    YP_MULTI_WRITE_NODE = 97,
    YP_NEXT_NODE = 98,
    YP_NIL_NODE = 99,
    YP_NO_KEYWORDS_PARAMETER_NODE = 100,
    YP_NUMBERED_REFERENCE_READ_NODE = 101,
    YP_OPTIONAL_PARAMETER_NODE = 102,
    YP_OR_NODE = 103,
    YP_PARAMETERS_NODE = 104,
    YP_PARENTHESES_NODE = 105,
    YP_PINNED_EXPRESSION_NODE = 106,
    YP_PINNED_VARIABLE_NODE = 107,
    YP_POST_EXECUTION_NODE = 108,
    YP_PRE_EXECUTION_NODE = 109,
    YP_PROGRAM_NODE = 110,
    YP_RANGE_NODE = 111,
    YP_RATIONAL_NODE = 112,
    YP_REDO_NODE = 113,
    YP_REGULAR_EXPRESSION_NODE = 114,
    YP_REQUIRED_DESTRUCTURED_PARAMETER_NODE = 115,
    YP_REQUIRED_PARAMETER_NODE = 116,
    YP_RESCUE_MODIFIER_NODE = 117,
    YP_RESCUE_NODE = 118,
    YP_REST_PARAMETER_NODE = 119,
    YP_RETRY_NODE = 120,
    YP_RETURN_NODE = 121,
    YP_SELF_NODE = 122,
    YP_SINGLETON_CLASS_NODE = 123,
    YP_SOURCE_ENCODING_NODE = 124,
    YP_SOURCE_FILE_NODE = 125,
    YP_SOURCE_LINE_NODE = 126,
    YP_SPLAT_NODE = 127,
    YP_STATEMENTS_NODE = 128,
    YP_STRING_CONCAT_NODE = 129,
    YP_STRING_NODE = 130,
    YP_SUPER_NODE = 131,
    YP_SYMBOL_NODE = 132,
    YP_TRUE_NODE = 133,
