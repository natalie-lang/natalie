...
NatObject *BasicObject_eqeq(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *BasicObject_neq(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *BasicObject_instance_eval(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *FalseClass_new(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *Integer_sub(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_mul(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_div(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_mod(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_pow(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_cmp(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_eqeqeq(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_times(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_bitwise_and(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_bitwise_or(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Integer_succ(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *Kernel_print(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_p(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_inspect(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_object_id(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_equal(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_class(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_singleton_class(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_instance_variables(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_instance_variable_get(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_instance_variable_set(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_raise(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_respond_to(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_dup(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_methods(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_exit(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_at_exit(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_is_a(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *Kernel_lambda(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_method(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_freeze(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_is_nil(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_sleep(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_define_singleton_method(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_tap(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_Array(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_send(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Kernel_cur_dir(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *MatchData_to_s(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *MatchData_ref(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *Module_inspect(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_eqeqeq(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_name(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_ancestors(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_attr_reader(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_attr_reader_block_fn(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_attr_writer(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_attr_writer_block_fn(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_attr_accessor(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_include(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_prepend(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_included_modules(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_define_method(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_class_eval(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_private(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_protected(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_const_defined(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Module_alias_method(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *NilClass_new(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
...
NatObject *Regexp_eqeq(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Regexp_inspect(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Regexp_eqtilde(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
NatObject *Regexp_match(NatEnv *env, NatObject *self, ssize_t argc, NatObject **args, NatBlock *block);
