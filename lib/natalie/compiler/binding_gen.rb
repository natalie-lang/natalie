...
gen.binding('Encoding', 'to_s', 'EncodingObject', 'name', argc: 0, pass_env: true, pass_block: false, return_type: :Object)
...
gen.singleton_binding('ENV', 'filter', 'EnvObject', 'select', argc: 0, pass_env: true, pass_block: true, return_type: :Object)
gen.singleton_binding('ENV', 'filter!', 'EnvObject', 'select_in_place', argc: 0, pass_env: true, pass_block: true, return_type: :Object)
...
gen.singleton_binding('ENV', 'select', 'EnvObject', 'select', argc: 0, pass_env: true, pass_block: true, return_type: :Object)
gen.singleton_binding('ENV', 'select!', 'EnvObject', 'select_in_place', argc: 0, pass_env: true, pass_block: true, return_type: :Object)
...
gen.static_binding('File', 'open', 'FileObject', 'open', argc: 1..3, pass_env: true, pass_block: true, return_type: :Object)
...
gen.binding('Dir', 'path', 'DirObject', 'path', argc: 0, pass_env: true, pass_block: false, return_type: :Object)
gen.binding('Dir', 'pos', 'DirObject', 'tell', argc: 0, pass_env: true, pass_block: false, return_type: :Object)
...
gen.binding('Dir', 'tell', 'DirObject', 'tell', argc: 0, pass_env: true, pass_block: false, return_type: :Object)
gen.binding('Dir', 'to_path', 'DirObject', 'path', argc: 0, pass_env: true, pass_block: false, return_type: :Object)
...
gen.static_binding('IO', 'sysopen', 'IoObject', 'sysopen', argc: 1, pass_env: true, pass_block: false, return_type: :Object)
...
gen.binding('IO', 'path', 'IoObject', 'get_path', argc: 0, pass_env: false, pass_block: false, return_type: :Object)
gen.binding('IO', 'pos', 'IoObject', 'pos', argc: 0, pass_env: true, pass_block: false, return_type: :int)
...
gen.binding('IO', 'tell', 'IoObject', 'pos', argc: 0, pass_env: true, pass_block: false, return_type: :int)
...
gen.binding('IO', 'to_path', 'IoObject', 'get_path', argc: 0, pass_env: false, pass_block: false, return_type: :Object)
...
gen.binding('Module', 'class_exec', 'ModuleObject', 'module_exec', argc: :any, pass_env: true, pass_block: true, return_type: :Object)
...
gen.binding('Module', 'module_exec', 'ModuleObject', 'module_exec', argc: :any, pass_env: true, pass_block: true, return_type: :Object)
...
gen.module_function_binding('Process', 'getsid', 'ProcessModule', 'getsid', argc: 1, pass_env: true, pass_block: false, return_type: :int)
...
gen.static_binding('Regexp', 'escape', 'RegexpObject', 'quote', argc: 1, pass_env: true, pass_block: false, pass_klass: false, return_type: :Object)
...
gen.binding('Symbol', '[]', 'SymbolObject', 'ref', argc: 1..2, pass_env: true, pass_block: false, return_type: :Object)
...
gen.binding('Symbol', 'slice', 'SymbolObject', 'ref', argc: 1..2, pass_env: true, pass_block: false, return_type: :Object)
