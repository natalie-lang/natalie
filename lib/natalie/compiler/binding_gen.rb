...
gen.binding('Kernel', 'send', 'KernelModule', 'send_message', argc: 1.., pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('Module', 'class_eval', 'ModuleValue', 'class_eval', argc: 0, pass_env: true, pass_block: true, return_type: :Value)
