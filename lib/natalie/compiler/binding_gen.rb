...
gen.binding('Array', 'cycle', 'ArrayValue', 'cycle', argc: 0..1, pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('Array', 'difference', 'ArrayValue', 'difference', argc: :any, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('Array', 'fetch', 'ArrayValue', 'fetch', argc: 1..2, pass_env: true, pass_block: true, return_type: :Value)
gen.binding('Array', 'fill', 'ArrayValue', 'fill', argc: 0..3, pass_env: true, pass_block: true, return_type: :Value)
gen.binding('Array', 'filter', 'ArrayValue', 'select', argc: 0, pass_env: true, pass_block: true, return_type: :Value)
gen.binding('Array', 'filter!', 'ArrayValue', 'select_in_place', argc: 0, pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('Array', 'initialize', 'ArrayValue', 'initialize', argc: 0..2, pass_env: true, pass_block: true, return_type: :Value, visibility: :private)
gen.binding('Array', 'initialize_copy', 'ArrayValue', 'initialize_copy', argc: 1, pass_env: true, pass_block: false, return_type: :Value, visibility: :private)
...
gen.binding('Array', 'pop', 'ArrayValue', 'pop', argc: 0..1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Array', 'product', 'ArrayValue', 'product', argc: :any, pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('Array', 'reject!', 'ArrayValue', 'reject_in_place', argc: 0, pass_env: true, pass_block: true, return_type: :Value)
gen.binding('Array', 'replace', 'ArrayValue', 'initialize_copy', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('Array', 'select!', 'ArrayValue', 'select_in_place', argc: 0, pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('Array', 'to_a', 'ArrayValue', 'to_ary_method', argc: 0, pass_env: false, pass_block: false, return_type: :Value)
gen.binding('Array', 'to_ary', 'ArrayValue', 'to_ary_method', argc: 0, pass_env: false, pass_block: false, return_type: :Value)
...
gen.binding('BasicObject', 'equal?', 'Value', 'equal', argc: 1, pass_env: false, pass_block: false, return_type: :bool)
...
gen.binding('Sexp', 'new', 'SexpValue', 'new_method', argc: :any, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Sexp', 'inspect', 'SexpValue', 'inspect', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Sexp', 'sexp_type', 'SexpValue', 'first', argc: 0..1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Sexp', 'file', 'SexpValue', 'file', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Sexp', 'file=', 'SexpValue', 'set_file', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Sexp', 'line', 'SexpValue', 'line', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Sexp', 'line=', 'SexpValue', 'set_line', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('String', 'lstrip', 'StringValue', 'lstrip', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
