...
gen.binding('IO', 'gets', 'IoObject', 'gets', argc: 0..1, kwargs: [:chomp], pass_env: true, pass_block: false, return_type: :Object)
...
gen.binding('IO', 'readline', 'IoObject', 'readline', argc: 0..1, kwargs: [:chomp], pass_env: true, pass_block: false, return_type: :Object)
