...
gen.binding('Encoding::Converter', 'source_encoding', 'EncodingConverterObject', 'source_encoding', argc: 0, pass_env: false, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'destination_encoding', 'EncodingConverterObject', 'destination_encoding', argc: 0, pass_env: false, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'replacement', 'EncodingConverterObject', 'replacement', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'replacement=', 'EncodingConverterObject', 'set_replacement', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'primitive_convert', 'EncodingConverterObject', 'primitive_convert', argc: :any, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'primitive_errinfo', 'EncodingConverterObject', 'primitive_errinfo', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'convpath', 'EncodingConverterObject', 'convpath', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'putback', 'EncodingConverterObject', 'putback', argc: 0..1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'last_error', 'EncodingConverterObject', 'last_error', argc: 0, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('Encoding::Converter', 'insert_output', 'EncodingConverterObject', 'insert_output', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.static_binding_as_class_method('Encoding::Converter', 'asciicompat_encoding', 'EncodingConverterObject', 'asciicompat_encoding', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.static_binding_as_class_method('Encoding::Converter', 'search_convpath', 'EncodingConverterObject', 'search_convpath', argc: :any, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('IO', 'reopen', 'IoObject', 'reopen', argc: 1..2, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('IO::Buffer', 'get_value', 'IoBufferObject', 'get_value', argc: 2, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'set_value', 'IoBufferObject', 'set_value', argc: 3, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'copy', 'IoBufferObject', 'copy', argc: 1..4, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'clear', 'IoBufferObject', 'clear', argc: 0..3, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'read', 'IoBufferObject', 'read', argc: 1..3, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'write', 'IoBufferObject', 'write', argc: 1..3, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'pread', 'IoBufferObject', 'pread', argc: 2..4, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'pwrite', 'IoBufferObject', 'pwrite', argc: 2..4, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'each', 'IoBufferObject', 'each', argc: 0..3, pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('IO::Buffer', '|', 'IoBufferObject', 'op_or', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'or!', 'IoBufferObject', 'or_bang', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', '^', 'IoBufferObject', 'op_xor', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
gen.binding('IO::Buffer', 'xor!', 'IoBufferObject', 'xor_bang', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('IO::Buffer', 'valid?', 'IoBufferObject', 'is_valid', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'external?', 'IoBufferObject', 'is_external', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'internal?', 'IoBufferObject', 'is_internal', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'mapped?', 'IoBufferObject', 'is_mapped', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'shared?', 'IoBufferObject', 'is_shared', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'locked?', 'IoBufferObject', 'is_locked', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'private?', 'IoBufferObject', 'is_private', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
gen.binding('IO::Buffer', 'readonly?', 'IoBufferObject', 'is_readonly', argc: 0, pass_env: false, pass_block: false, return_type: :bool)
...
gen.binding('String', 'rpartition', 'StringObject', 'rpartition', argc: 1, pass_env: true, pass_block: false, return_type: :Value)
...
gen.binding('String', 'scrub', 'StringObject', 'scrub', argc: 0..1, pass_env: true, pass_block: true, return_type: :Value)
gen.binding('String', 'scrub!', 'StringObject', 'scrub_in_place', argc: 0..1, pass_env: true, pass_block: true, return_type: :Value)
...
gen.binding('String', 'split', 'StringObject', 'split', argc: 0..2, pass_env: true, pass_block: true, return_type: :Value)
