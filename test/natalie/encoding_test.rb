...
describe 'encodings' do
  describe 'EUC-JP' do
    it 'can convert codepoints' do
      [0x61, 0xA1A1, 0x8FFEF1].each { |codepoint| codepoint.chr(Encoding::EUC_JP).ord.should == codepoint }
    end
    ...
    it 'can chop a character (this uses EncodingObject::prev_char)' do
      [0x61, 0xA1A1, 0x8FFEF1].each do |codepoint|
  ...
  describe 'ISO-8859-1' do
    ...
    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xFF => 0xFF }.each do |codepoint, expected|
    ...
    it 'can chop a character (this uses EncodingObject::prev_char)' do
      [0x61, 0x8E, 0xFF].each do |codepoint|
  ...
  describe 'ISO-8859-2' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_2).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA1 => 0x104 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_2).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x104 => 0xA1 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-3' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_3).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA1 => 0x126 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_3).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x126 => 0xA1 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-4' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_4).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xE0 => 0x101 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_4).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x101 => 0xE0 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-5' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_5).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xE0 => 0x440 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_5).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x440 => 0xE0 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-6' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_6).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xE0 => 0x640 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_6).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x640 => 0xE0 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-7' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_7).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0xA8, 0xE0 => 0x3B0 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_7).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0xA8, 0x3B0 => 0xE0 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-8' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_8).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0xA8, 0xE0 => 0x5D0 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_8).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0xA8, 0x5D0 => 0xE0 }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-9' do
    before :each do
      @exceptions = { 0xD0 => 0x11E, 0xDD => 0x130, 0xDE => 0x15E, 0xF0 => 0x11F, 0xFD => 0x131, 0xFE => 0x15F }
    end

    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_9).ord.should == codepoint }
    end
  ...
  describe 'ISO-8859-10' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_10).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0x13B, 0xFF => 0x138 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_10).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x13B => 0xA8, 0x138 => 0xFF }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-11' do
    ...
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_11).ord.should == codepoint }
    end
  ...
  describe 'ISO-8859-13' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_13).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0xD8, 0xFF => 0x2019 }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_13).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xD8 => 0xA8, 0x2019 => 0xFF }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-14' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_14).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0x1E80, 0xFF => 0xFF }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_14).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x1E80 => 0xA8, 0xFF => 0xFF }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-15' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_15).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0xA8 => 0x161, 0xFF => 0xFF }.each do |codepoint, expected|
        codepoint.chr(Encoding::ISO_8859_15).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x8E, 0x161 => 0xA8, 0xFF => 0xFF }.each do |codepoint, expected|
  ...
  describe 'ISO-8859-16' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::ISO_8859_16).ord.should == codepoint }
    end
  ...
  describe 'Windows-1250' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1250).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x17D, 0xA8 => 0xA8, 0xFF => 0x2D9 }.each do |codepoint, expected|
        codepoint.chr(Encoding::Windows_1250).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x17D => 0x8E, 0xA8 => 0xA8, 0x2D9 => 0xFF }.each do |codepoint, expected|
  ...
  describe 'Windows-1253' do
    it 'can convert codepoints' do
      [0x61, 0xC4, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1253).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0xC4 => 0x394 }.each do |codepoint, expected|
        codepoint.chr(Encoding::Windows_1253).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x394 => 0xC4 }.each do |codepoint, expected|
  ...
  describe 'UTF-16BE' do
    it 'can convert codepoints' do
      [0x61, 0x20AC, 0x1FAFF].each { |codepoint| codepoint.chr(Encoding::UTF_16BE).ord.should == codepoint }
    end
    ...
    it 'can chop a character (this uses EncodingObject::prev_char)' do
      [0x61, 0x20AC, 0x8EA1, 0x1F4A9, 0x1FAFF].each do |codepoint|
  ...
  describe 'UTF-16LE' do
    it 'can convert codepoints' do
      [0x61, 0x20AC, 0x1FAFF].each { |codepoint| codepoint.chr(Encoding::UTF_16LE).ord.should == codepoint }
    end
  ...
  describe 'Windows-1251' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1251).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x40B, 0xA8 => 0x401, 0xFF => 0x44F }.each do |codepoint, expected|
        codepoint.chr(Encoding::Windows_1251).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x40B => 0x8E, 0x401 => 0xA8, 0x44F => 0xFF }.each do |codepoint, expected|
  ...
  describe 'Windows-1252' do
    it 'can convert codepoints' do
      [0x61, 0x8E, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1252).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x8E => 0x17D, 0xA8 => 0xA8, 0xFF => 0xFF }.each do |codepoint, expected|
        codepoint.chr(Encoding::Windows_1252).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x17D => 0x8E, 0xA8 => 0xA8, 0xFF => 0xFF }.each do |codepoint, expected|
  ...
  describe 'Windows-1254' do
    it 'can convert codepoints' do
      [0x61, 0x8D, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1254).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0xD0 => 0x11E, 0xFF => 0xFF }.each do |codepoint, expected|
    ...
    it 'cannot convert certain codepoints to UTF-8' do
      [0x81, 0x8D, 0x8E, 0x8F, 0x90, 0x9D, 0x9E].each do |codepoint|
        -> { codepoint.chr(Encoding::Windows_1254).encode(Encoding::UTF_8) }.should raise_error(
                     Encoding::UndefinedConversionError,
                     /from Windows-1254 to UTF-8/,
                   )
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x11E => 0xD0, 0xFF => 0xFF }.each do |codepoint, expected|
        codepoint.chr(Encoding::UTF_8).encode(Encoding::Windows_1254).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can chop a character (this uses EncodingObject::prev_char)' do
      [0x61, 0x8C, 0xFF].each do |codepoint|
  ...
  describe 'Windows-1255' do
    it 'can convert codepoints' do
      [0x61, 0x8D, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1255).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0xD0 => 0x5C0 }.each do |codepoint, expected|
        codepoint.chr(Encoding::Windows_1255).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'cannot convert certain codepoints to UTF-8' do
      [0x81, 0x8D, 0x8E, 0x8F, 0x90, 0x9D, 0x9E, 0xFF].each do |codepoint|
        -> { codepoint.chr(Encoding::Windows_1255).encode(Encoding::UTF_8) }.should raise_error(
                     Encoding::UndefinedConversionError,
    ...
    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x5C0 => 0xD0 }.each do |codepoint, expected|
  ...
  describe 'Windows-1256' do
    it 'can convert codepoints' do
      [0x61, 0x8D, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1256).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x80 => 0x20AC, 0x81 => 0x67E }.each do |codepoint, expected|
        codepoint.chr(Encoding::Windows_1256).encode(Encoding::UTF_8).ord.to_s(16).should == expected.to_s(16)
      end
    end

    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x20AC => 0x80, 0x67E => 0x81 }.each do |codepoint, expected|
  ...
  describe 'Windows-1257' do
    it 'can convert codepoints' do
      [0x61, 0x8D, 0xFF].each { |codepoint| codepoint.chr(Encoding::Windows_1257).ord.should == codepoint }
    end

    it 'can convert to UTF-8' do
      { 0x61 => 0x61, 0x80 => 0x20AC, 0xC0 => 0x104 }.each do |codepoint, expected|
    ...
    it 'can convert from UTF-8' do
      { 0x61 => 0x61, 0x20AC => 0x80, 0x104 => 0xC0 }.each do |codepoint, expected|
